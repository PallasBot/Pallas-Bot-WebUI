import { protocolFetchBatchJob, protocolStreamBatchJob, type ProtocolBatchJobPayload } from "@/api/protocolApi";

export type ProtocolBatchPhase =
  | "pending"
  | "running"
  | "stopping"
  | "starting"
...
export type ProtocolBatchJob = ProtocolBatchJobPayload & {
  phase: ProtocolBatchPhase | string;
};
...
export async function waitForProtocolBatchJob(
  ...
  jobId: string,
  options?: {
    onProgress?: (job: ProtocolBatchJob) => void;
    pollMs?: number;
  },
