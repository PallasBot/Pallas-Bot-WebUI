...
export const routeChunkLoaders: Record<string, () => Promise<unknown>> = {
  ...
  "protocol-create": () => import("@/pages/ProtocolCreatePage.vue"),
  "protocol-import": () => import("@/pages/ProtocolImportPage.vue"),
  "protocol-assets": () => import("@/pages/ProtocolAssetsPage.vue"),
...
const pathToRouteName: Record<string, string> = {
  ...
  "/instances": "instances",
  "/protocol": "protocol",
  "/protocol/create": "protocol-create",
  "/protocol/import": "protocol-import",
